...
<head>
    ...
    <link rel="stylesheet" href="CSS/style_error-page.css">
                                ...
                                <div class="client-form-container__row__group__controls__control">
                                    <div class="client-form-container__row__group__controls__control__dropdown">
                                        <select name="estadoCivil" id="estadoCivil">
                                            ...
                                            <?php
                                                if($mostrar["estado_civil"] == "Soltero")
                                                {
                                            ?>
                                                    <option value="Soltero" selected>Soltero</option>
                                            <?php 
                                                }
                                                if($mostrar["estado_civil"] == "Casado")
                                                {
                                            ?>
                                                    <option value="Casado" selected>Casado</option>
                                            <?php 
                                                }
                                                if($mostrar["estado_civil"] == "Divorciado")
                                                {
                                            ?>
                                                    <option value="Divorciado" selected>Divorciado</option>
                                            <?php 
                                                }
                                                if($mostrar["estado_civil"] == "Separacion en proceso")
                                                {
                                            ?>
                                                    <option value="Separacion en proceso">Separacion en proceso</option>
                                            <?php 
                                                }
                                                if($mostrar["estado_civil"] == "Viudo")
                                                {
                                            ?>
                                                    <option value="Viudo" selected>Viudo</option>
                                            <?php 
                                                }
                                                if($mostrar["estado_civil"] == "Concubinato")
                                                {
                                            ?>
